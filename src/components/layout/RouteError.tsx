...
/**
 * Route error boundary: a branded page instead of the router's default,
 * with no error details or stack. It draws its own minimal frame rather
 * than Navbar/Footer, which may be what threw.
 */
export default function RouteError(): ReactElement {
  ...
  return (
    <div className="min-h-screen">
      <header className="border-b-[3px] border-[var(--border-strong)] bg-[var(--surface)] px-6 py-4">
        <a
          className="font-pixel text-[12px] text-[var(--text-primary)]"
          href="/"
        >
          PignuAnte
        </a>
